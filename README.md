...
During a live disaster, information is scattered across many sources, frequently contradictory, and changes by the minute — evacuation status, road closures, shelter availability. Getting it wrong isn't just a bug: bad information layer can put people at real risk. Most monitoring tools aggregate and display; they don't know when their own picture of the world has gone stale, contradictory, or broken.
